...
export default connect(
  ...
  class YoythVideo extends Component {
    constructor (props) {
      super(props)
      this.state = {
        hidden: true
    ...
    render () {
      ...
      return (
        <Video style={this.state.brick && this.state.brick.style ? JSON.parse(this.state.brick.style) : null}>
          <iframe allowFullScreen={true}
            src={this.state.brick.address} />
          {this.state.credtxt}
